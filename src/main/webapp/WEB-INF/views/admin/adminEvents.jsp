...
uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %> <%@ include file="/WEB-INF/views/admin/templates/header.jsp" %>
...
<html lang="ko">
  ...
  <body>
    <div class="main-content">
      ...
      <button class="btn edit-btn" style="margin-top: 40px; width: auto" onclick="location.href='/admin/events/write'">이벤트작성</button>
    </div>
  </body>
</html>
